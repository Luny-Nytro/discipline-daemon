...
export type Error = Unique<"Discilpine.UserAccess.Operations.Enabler.ByPassword.MakeEffective.Error", Variant>
...
function UnknownVariantError(variant: string): GenericError.GenericError {
  return GenericError.create(
    `UserAccess.Operations.Enabler.ByPassword.MakeEffective.Error.fromString: Unknown variant. Expected ${
