...
export type EnumUnitVariant<Final> = Unique<"App.Elementary.JsonDeserializer.EnumUnitVariantDeserializer", {
...
export type EnumDataVariant<Final, DataFinal = unknown> = Unique<"App.Elementary.JsonDeserializer.EnumDataVariantDeserializer", {
