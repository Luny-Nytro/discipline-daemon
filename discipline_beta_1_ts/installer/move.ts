...
// switch (action) {
//   case "enable": {
//     new Deno.Command("systemd", { args: [ "enable", "${serviceId}" ], stdout: "inherit", stderr: "inherit" }).outputSync()
//     break
//   }
//   case "disable": {
//     new Deno.Command("systemd", { args: [ "disable", "${serviceId}" ], stdout: "inherit", stderr: "inherit" }).outputSync()
//     break
//   }
//   case "start": {
//     new Deno.Command("systemd", { args: [ "start", "${serviceId}" ], stdout: "inherit", stderr: "inherit" }).outputSync()
//     break
//   }
//   case "stop": {
//     new Deno.Command("systemd", { args: [ "stop", "${serviceId}" ], stdout: "inherit", stderr: "inherit" }).outputSync()
//     break
//   }
//   default: {
...
// const service = createServiceFileContent(exeute, `file:${destinationStderr}`, `file:${destinationStdout}`)
