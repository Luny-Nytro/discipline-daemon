...
export type Operation = Unique<"Discipline.NetworkingAccess.Operations.RuleEnforcer.Disable", {
...
export const displayer = Displayer.implement<Operation>(me => 
  Displayer.asNamedObject("DisableRuleEnforcer", 
...
export const executer = Client.Executer.implement(
  [ "NetworkingAccess", "RuleEnforcers", "Disable" ],
  create,
  displayer,
  jsonSerializer,
  jsonDeserializer,
