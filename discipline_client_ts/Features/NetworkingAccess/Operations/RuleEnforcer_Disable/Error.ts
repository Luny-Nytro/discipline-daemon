...
export type Error = Unique<"Discipline.NetworkingAccess.Opreations.RuleEnforcer.Disable.Error", Variant>
...
function UnknownVariantError(variant: string): GenericError.GenericError {
  return GenericError.create(
    `NetworkingAccess.Operations.RuleEnforcer.Disable.Error.fromString: Unknown variant. Expected ${
