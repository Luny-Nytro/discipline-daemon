...
export type Operation = Unique<"Discipline.NetworkingAccess.Operations.RuleEnforcer.Delete", {
...
export const displayer = Displayer.implement<Operation>(me => 
  Displayer.asNamedObject("DeleteRuleEnforcer", 
...
export const executer = Client.Executer.implement(
  [ "NetworkingAccess", "RuleEnforcers", "Delete" ],
  create,
  displayer,
  jsonSerializer,
  jsonDeserializer,
