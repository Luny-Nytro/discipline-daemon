...
export type Error = Unique<"Discipline.NetworkingAccess.Operations.Rule.Create.Error", Variant>
...
function UnknownVariantError(variant: string): GenericError.GenericError {
  return GenericError.create(
    `NetworkingAccess.Operations.Rule.Create.Error.fromString: Unknown variant. Expected ${
