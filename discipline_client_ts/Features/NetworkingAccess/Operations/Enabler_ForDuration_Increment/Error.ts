...
export type Error = Unique<"Discipline.NetworkingAccess.Operations.Enabler.Forduration.Increment.Error", Variant>
...
function UnknownVariantError(variant: string): GenericError.GenericError {
  return GenericError.create(
    `NetworkingAccess.Operations.Enabler.ForDuration.Increment.Error.fromString: Unknown variant. Expected ${
