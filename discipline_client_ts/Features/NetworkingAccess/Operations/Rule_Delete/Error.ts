...
export type Error = Unique<"Discipline.NetworkingAccess.Operations.Rule.Delete.Error", Variant>
...
function UnknownVariantError(variant: string): GenericError.GenericError {
  return GenericError.create(
    `NetworkingAccess.Operations.Rule.Delete.Error.fromString: Unknown variant. Expected ${
