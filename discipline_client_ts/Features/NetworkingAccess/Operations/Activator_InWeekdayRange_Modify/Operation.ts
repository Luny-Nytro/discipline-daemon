...
export type Operation = Unique<"Discipline.NetworkingAccess.Operations.Activator.InWeekdayRange.Modify", {
...
export const executer = Client.Executer.implement(
  [ "NetworkingAccess", "Rules", "Activator", "InWeekdayRange", "Modify" ],
  create,
  displayer,
  jsonSerializer,
  jsonDeserializer,
