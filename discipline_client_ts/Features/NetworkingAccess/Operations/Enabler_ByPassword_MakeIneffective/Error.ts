...
export type Error = Unique<"Discipline.NetworkingAccess.Operations.Enabler.ByPassword.MakeIneffective.Error", Variant>
...
function UnknownVariantError(variant: string): GenericError.GenericError {
  return GenericError.create(
    `NetworkingAccess.Operations.Enabler.ByPassword.MakeIneffective.Error.fromString: Unknown variant. Expected ${
