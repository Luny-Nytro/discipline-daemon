...
export type Operation = Unique<"Discipline.NetworkingAccess.Operations.Enabler.ByPassword.MakeIneffective", {
...
export const executer = Client.Executer.implement(
  [ "NetworkingAccess", "Rules", "Enabler", "ByPassword", "MakeIneffective" ],
  create,
  displayer,
  jsonSerializer,
  jsonDeserializer,
