...
export type Error = Unique<"Discipline.UserAccess.Operations.Activator.InWeekdayRange.Modify.Error", Variant>
...
function UnknownVariantError(string: string): GenericError.GenericError {
  return GenericError.create(
    `UserAccess.Operations.Activator.InWeekdayRange.Modify.Error.fromString: Unknwn Error Variant. Expected ${
