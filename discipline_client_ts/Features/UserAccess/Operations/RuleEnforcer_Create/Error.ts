...
export type Error = Unique<"Discipline.UserAccess.Operations.RuleEnforcer.Create.Error", Variant>
...
function UnknownVariantError(variant: string): GenericError.GenericError {
  return GenericError.create(
    `UserAccess.Operations.RuleEnforcer.Create.Error.fromString: Unknown variant. Expected ${
