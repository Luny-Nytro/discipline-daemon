...
export type Error = Unique<"Discipline.UserAccess.Operations.RuleEnforcer.Delete.Error", Variant>
...
function UnknownVariantError(variant: string): GenericError.GenericError {
  return GenericError.create(
    `UserAccess.Operations.RuleEnforcer.Delete.Error.fromString: Unknown variant. Expected ${
