...
export type Error = Unique<"Discipline.UserAccess.Operations.Activator.ForDuration.Increment", Variant>
...
function createFromStringError(string: string): GenericError.GenericError {
  return GenericError.create(
    `UserAccess.Operations.Activator.ForDuration.Increment.Error.fromString: Expected ${
