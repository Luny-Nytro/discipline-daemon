...
export type Error = Unique<"Discipline.UserAccess.Operations.Activator.InTimeRange.Modify.Error", Variant>
...
function UnknownErrorVariant(string: string): GenericError.GenericError {
  return GenericError.create(
    `UserAccess.Activator.InTimeRange.Modify.Error.fromString: Unknown Error Variant. Expected ${
