...
export type Error = Unique<"Discipline.UserAccess.Operations.RuleEnforcer.Enable.Error", Variant>
...
function UnknownVariantError(variant: string): GenericError.GenericError {
  return GenericError.create(
    `UserAccess.Operations.RuleEnforcer.Enable.Error.fromString: Unknown variant. Expected ${
