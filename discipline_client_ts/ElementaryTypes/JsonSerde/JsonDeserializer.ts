...
export type EnumUnitVariant<Return> = Unique<"Discipline.Elementary.JsonDeserializer.EnumUnitVariantDeserializer", {
...
export type EnumDataVariant<Data, Return> = Unique<"Discipline.Elementary.JsonDeserializer.EnumDataVariantDeserializer", {
