...
export type Executer<
  ...
  OperationOutcome,
> = Unique<"Discipline.Client.Executer", {
  readonly execute: (
  ...
  readonly displayer: Displayer.Displayer<Tried<OperationOutcome, Error.T>>
}>
...
>(
  ...
  operationDisplayer: Displayer.Displayer<Operation>,
  ...
  operationOutcomeDisplayer: Displayer.Displayer<OperationOutcome>,
