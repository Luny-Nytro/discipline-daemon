...
use crate::Daemon;
use super::public::*;
use crate::database::screen_access_regulation_rule as rule_db;
use crate::database::screen_access_regulation_policy as policy_db;
...
impl CreatePolicy {
  pub const HUMAN_READABLE_ID: &'static str = "ScreenAccessRegulationCreatePolicy";
  ...
  pub fn execute(self, daemon: Arc<Daemon>) -> CreatePolicyReturn {
    ...
    let regulation = &mut user.user_screen_access_regulation_logic;
...
impl DeletePolicy {
  pub const HUMAN_READABLE_ID: &'static str = "ScreenAccessRegulationDeletePolicy";
...
impl UpdatePolicyName {
  pub const HUMAN_READABLE_ID: &'static str = "ScreenAccessRegulationUpdatePolicyName";
...
impl IncreasePolicyProtection {
  pub const HUMAN_READABLE_ID: &'static str = "ScreenAccessRegulationIncreasePolicyProtection";
...
impl CreateRule {
  pub const HUMAN_READABLE_ID: &'static str = "ScreenAccessRegulationCreateRule";
...
impl DeleteRule {
  pub const HUMAN_READABLE_ID: &'static str = "ScreenAccessRegulationDeleteRule";
...
impl UpdateRuleActivatorTimeRange {
  pub const HUMAN_READABLE_ID: &'static str = "ScreenAccessRegulationUpdateRuleActivatorTimeRange";
...
impl UpdateRuleActivatorWeekdayRange {
  pub const HUMAN_READABLE_ID: &'static str = "ScreenAccessRegulationUpdateRuleActivatorWeekdayRange";
