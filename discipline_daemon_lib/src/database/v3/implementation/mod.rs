...
pub mod screen_access_regulation_rule_collection;
pub use screen_access_regulation_rule_collection::RuleCollection as UserScreenAccessRuleCollection;
pub use screen_access_regulation_rule_collection::NormalizedRule as UserScreenAccessRuleNormalized;
